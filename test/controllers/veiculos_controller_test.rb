...
class VeiculosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veiculo" do
    assert_difference("Veiculo.count") do
      post veiculos_url, params: { veiculo: { chassi: @veiculo.chassi, cor: @veiculo.cor, marca: @veiculo.marca, modelo: @veiculo.modelo, placa: @veiculo.placa } }
    end
  ...
  test "should update veiculo" do
    patch veiculo_url(@veiculo), params: { veiculo: { chassi: @veiculo.chassi, cor: @veiculo.cor, marca: @veiculo.marca, modelo: @veiculo.modelo, placa: @veiculo.placa } }
